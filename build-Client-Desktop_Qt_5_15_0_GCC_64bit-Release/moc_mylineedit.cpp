...
QT_MOC_LITERAL(1, 11, 17), // "editDoubleClicked"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "myLineEdit\0editDoubleClicked\0"
};
...
void myLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->editDoubleClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myLineEdit::editDoubleClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myLineEdit::editDoubleClicked()
{
